...
import { PageInfo } from "vuepress-theme-hope/lib/shared/index.js";
          ...
          entries(buttons).map(([key, Icon]) =>
            h(
              ...
              h(
                "div",
                {
                  class: ["icon-wrapper", { active: activeType.value === key }],
